...
$sqll="CREATE TABLE temp (id INT(100), o_id INT(6), b_id INT(6), quantity INT(6));";
...
//for redo
//create temp_unre table for undo-redo
//$sqll="CREATE TABLE temp_unre (id INT(100), o_id INT(6), b_id INT(6), quantity INT(6));";
//$sqll3="SELECT * FROM temp_unre WHERE 1";

//if no temp_unre table, create one
//if(!mysqli_query($conn, $sqll3)) $result1=mysqli_query($conn, $sqll);
//$sqll2 = "SELECT * FROM temp";
//$result1=mysqli_query($conn, $sqll2);
