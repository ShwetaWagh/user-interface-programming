        ...
        <div>
            <div class="customer_row">
                ...
                <div class="customer_col_50 customer_pay_right customer_pay_center">
                    ...
                    <br>
                    <h1 lang="en">We have received your order!</h1>
                    <h1 lang="ch">我們已經收到您的訂單了！</h1>

                    <h3 lang="en">Collect your drink at the bar when your order number is shown on the screen =D</h3>
                    <h3 lang="ch">當您的訂單號顯示在屏幕上時，您可以在酒吧取得您的飲品</h3>
                    <div class="customer_pay_center">
                        <a href="customer_index.php">
